        ...
        <div class="col-12 col-lg-12">
            <div class="card border p-3">
                ...
                <div class="form-group mb-3">
                    ...
                    <textarea id="description" placeholder="{{ __('VarenykyECom::labels.description') }}..." name="description" class="form-control @if ($errors->has('description')) is-invalid @endif" rows="4">{{ old('description') }}</textarea>
                </div>
                ...
                <div class="form-group mb-3">
                    ...
                    <input id="is_active" type="number" placeholder="{{ __('VarenykyECom::labels.is_active') }}..." name="is_active" class="form-control @if ($errors->has('is_active')) is-invalid @endif" value="{{ old('is_active') }}">
                </div>
            </div>
        </div>
    </div>
